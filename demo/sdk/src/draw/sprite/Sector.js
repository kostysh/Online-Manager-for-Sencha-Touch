...
Ext.define("Ext.draw.sprite.Sector", {
    ...
    drawPath: function (path, attr) {
        var baseRotation = attr.baseRotation,
            startAngle = Math.min(attr.startAngle, attr.endAngle) + baseRotation,
            endAngle = Math.max(attr.startAngle, attr.endAngle) + baseRotation,
