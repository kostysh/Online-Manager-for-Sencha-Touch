...
Ext.define('Ext.device.device.Abstract', {
     ...
     *                 console.log('Applicaton pened via another application: ' + Ext.device.Device.scheme.url);
     *             }
     *
     ...
     *
     * You can find a full list of available URL schemes here: http://wiki.akosma.com/IPhone_URL_Schemes
     *
     * ** PLEASE NOTE: This currently only works on iOS using the Sencha Native Packager. Attempting to use this on PhoneGap, iOS Simulator 
